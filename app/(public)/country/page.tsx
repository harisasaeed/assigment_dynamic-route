...
export default function Country(){
    ...
    return(
        ...
        <div>
        <Nav/>
        <div className="h-max w-80 bg-green-200 m-auto pb-6 mt-20 rounded-3xl font-semibold">
            ...
            <ul className=" list-none flex justify-center flex-col items-center gap-4 text-white text-center"> 
                <li className="text-lg py-2 bg-green-700 rounded-lg w-28 duration-100 hover:ease-linear hover:scale-110 ">
                ...
                <li className="text-lg py-1 bg-green-700 rounded-lg w-28 duration-100 hover:ease-linear hover:scale-110">
